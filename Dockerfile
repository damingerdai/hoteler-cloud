FROM azul/zulu-openjdk:25.0.4.1-jdk AS back-build
...
FROM azul/zulu-openjdk:25.0.4.1-jdk AS auth
WORKDIR /app
...
FROM azul/zulu-openjdk:25.0.4.1-jdk AS workflow
WORKDIR /app
...
FROM azul/zulu-openjdk:25.0.4.1-jdk AS orchestration
WORKDIR /app
